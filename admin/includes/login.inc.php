...
<html lang="es">
  ...
  <body class="d-flex align-items-center py-4 bg-body-tertiary fondo_sign-in">
...
<main class="form-signin w-100 m-auto bg-secondary bg-opacity-25 border border-dark border-2 rounded-3">
  <form role="form" action="./actions/login.act.php" method="post">
    ...
    <button class="btn btn-primary w-100 py-2" type="submit">Entrar</button>
     <!--Creamos el boton de registrar con un a, ya que el button nos daría problemas-->
     <a class="btn btn-secondary w-100 py-2"  href="index.php?page=registro">Registrar</a>
    <p class="mt-5 mb-3 text-body-secondary">&copy; HLC 2023-2024</p>
  </form>
</main>
